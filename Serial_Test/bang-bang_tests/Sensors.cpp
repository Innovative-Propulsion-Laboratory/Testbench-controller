...
void sensorsLoop(){
    ...
    serialSend();                                                   //send data to the serial monitor
...
void values_check(){
    ...
    if (Data.TS31 >= TS31_UW){
        if (TS31_UW_active == 1 && (millis()-TS31_UW_time) >= TS_oob_max_delay){
            ...
            Serial.println("warning: TS31 too high");
        }
...
void serialSend() {
    ...
    Serial.print("Valve State: "); Serial.println(Data.valvesState);

    if (Data.state == 0){Serial.print("State: "); Serial.println("Active");}
    else if (Data.state == 1){Serial.print("State: "); Serial.println("Test");}
    else if (Data.state == 2){Serial.print("State: "); Serial.println("Abort");}
