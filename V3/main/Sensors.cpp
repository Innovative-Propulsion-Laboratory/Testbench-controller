...
void read_atm_pressure(){
  ...
  Data.PS64 = PS_25bar_ADCreading(PS12_pin);
}
        ...
        switch (Data.test_step){
          ...
          case 8:
            if ((millis() - T0) >= (Sequence_data.GOX_to_ETH)) {
              setValve(SV25, 0);
              Serial.println("Fermeture SV25 :");
              Serial.println(millis());
              setValve(SV35, 1);
              Serial.println("Ouverture Purge : ");
              Serial.println(millis());
              Data.test_step++;
            }
            break;
...
void serialSend() {
  ...
  Serial.print("\t");
  Serial.print("PS64: ");
  Serial.print(Data.PS64);
  Serial.print("\t");
  Serial.print("PS71: ");
  Serial.print(Data.PS71);
  Serial.print("\t");
  Serial.print("PS81: ");
  Serial.println(Data.PS81);
...
void save_spe_Data() {
  ...
  if (!fp.open(current_file, O_WRONLY | O_APPEND)) {
    Serial.println("Error opening file for writing");
    return;
  }
...
void testcapteur(){
  ...
  Serial.print("PS11 :");
  Serial.println(PS_25bar_reading(PS11_pin));
  Serial.print("PS12 :");
  Serial.println(PS_25bar_reading(PS12_pin));
  Serial.print("PS21 :");
  Serial.println(PS_25bar_reading(PS21_pin));
  Serial.print("PS22 :");
  Serial.println(PS_25bar_reading(PS22_pin));
  Serial.print("PS23 :");
  Serial.println(PS_25bar_reading(PS23_pin));
  Serial.print("PS31 :");
  Serial.println(PS_70bar_reading(PS31_pin));
  Serial.print("PS41 :");
  Serial.println(PS_25bar_reading(PS41_pin));
  Serial.print("PS42 :");
  Serial.println(PS_25bar_reading(PS42_pin));
  Serial.print("PS51 :");
  Serial.println(PS_350bar_reading(PS51_pin));
  Serial.print("PS61 :");
  Serial.println(PS_25bar_reading(PS61_pin));
  Serial.print("PS62 :");
  Serial.println(PS_25bar_reading(PS62_pin));
  Serial.print("ADC sensors PS63 :");
  Serial.println(PS_25bar_ADCreading(PS63_pin));
  Serial.print("ADC sensors PS64 :");
  Serial.println(PS_25bar_ADCreading(PS64_pin));
  Serial.print("ADC sensors PS71 :");
  Serial.println(PS_25bar_ADCreading(PS71_pin));
